...
@REM git push -f https://github.com/Shuaiwen-Cui/STM_STUDY.git main
git push -f https://github.com/Shuaiwen-Cui/STM_STUDY.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/STM_STUDY.git
